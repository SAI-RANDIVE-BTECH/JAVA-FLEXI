☕ Java-Flexi - 25070122509 SYCSE B
...
1. Clone the repository:Bashgit clone https://github.com/YourUsername/Java-Flexi.git
2. Navigate to the specific day:Bashcd "Day 01"
3. Compile and Execute:Bashjavac HelloWorld.java
4. java HelloWorld
